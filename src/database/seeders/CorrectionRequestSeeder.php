...
CorrectionRequest::create([
    ...
    'clock_out' => Carbon\Carbon::parse($attendance1->clock_out)->addHour(),
    'reason' => '退勤打刻漏れ',
    'status' => 'pending',
]);
...
CorrectionRequest::create([
    ...
    'clock_in' => Carbon\Carbon::parse($attendance2->clock_in)->subMinutes(30),
...
CorrectionRequest::create([
    ...
    'clock_out' => Carbon\Carbon::parse($attendance3->clock_out)->addMinutes(30),
    'reason' => '業務対応による残業',
    'status' => 'pending',
]);
    }
